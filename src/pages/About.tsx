...
export default function About() {
  ...
  return (
    <div className="pt-24">
      <SEO 
        title="About ChargePush — Our Mission to Power India's EV Future"
        description="Learn how ChargePush is building a hyperlocal EV charging network by connecting riders with unused home outlets across India's neighborhoods."
      />
      {/* Hero */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/70 leading-relaxed">
                ChargePush was born from a simple observation: millions of EV two-wheeler riders in India struggle to find convenient charging points, while millions of homeowners have unused electricity outlets. We connect them.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="reveal">
            ...
            <div className="prose prose-lg text-muted-foreground mx-auto text-center">
              ...
              <p>
                That is how ChargePush was born. A hyperlocal marketplace where riders find nearby charging spots and homeowners earn passive income from their existing outlets. No heavy equipment, no special installation, just community-powered charging.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 reveal">
            {[
              ...
              { icon: Leaf, title: "Green Impact", desc: "Every charge on ChargePush reduces emissions and fossil fuel dependence." },
            ].map((item, i) => {
      ...
      <CTABanner variant="dark" title="Join the ChargePush Movement" subtitle="Be part of India's community-powered EV charging revolution." />
    </div>
  );
}
